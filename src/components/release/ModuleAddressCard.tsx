...
import { ExternalLink, CheckCircle2, Info, Copy as CopyIcon, Shield, Clock, Calendar, Timer, Banknote, Coins, Eye, EyeOff } from "lucide-react";
...
export function ModuleAddressCard({
  ...
  return (
    <Card className="bg-gray-900 rounded-3xl border border-gray-800 p-4 shadow-2xl mb-4">
      <div className="flex items-center mb-3">
        <Shield className="h-5 w-5 text-purple-400 mr-2" />
        <h2 className="text-xl font-semibold text-white">Module Information</h2>
